...
export default function AiPlaceholderPanel({ onOpenModal }: AiPlaceholderPanelProps) {
  return (
    <div className="panel">
      ...
      <button className="btn pink" onClick={onOpenModal}>GENERATE PLACEHOLDER CODE</button>
    </div>
  );
}